...
namespace TestApp.Migrations
{
    ...
    [Migration("20210225151612_datumPotvrde")]
    partial class datumPotvrde
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestApp.DB.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TestApp.DB.Narudzbina", b =>
                {
                    ...
                    b.Property<DateTime?>("DatumPotvrdeNarudzbine")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int?>("VremeIsporukeUDanima")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestApp.DB.Proizvod", b =>
                {
                    ...
                    b.Property<int?>("NacinKoriscenja")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestApp.DB.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TestApp.DB.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TestApp.DB.RefreshToken", b =>
                {
                    b.HasOne("TestApp.DB.ApplicationUser", "User")
